...
export declare class NgbPopover implements OnInit, OnDestroy, OnChanges {
    ...
    private _isDisabled;
    constructor(_elementRef: ElementRef<HTMLElement>, _renderer: Renderer2, injector: Injector, componentFactoryResolver: ComponentFactoryResolver, viewContainerRef: ViewContainerRef, config: NgbPopoverConfig, _ngZone: NgZone, _document: any, _autoClose: AutoClose, _changeDetector: ChangeDetectorRef);
    /**
